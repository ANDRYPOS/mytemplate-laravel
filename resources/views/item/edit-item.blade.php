    ...
    <div class="w-full px-6 mx-auto mb-4">
        <a
            ...
            @foreach ($item as $dataitem)
                <form class="w-full max-w-lg" method="post" action="{{ url('update-item') }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    {{-- categories & name --}}
                    <div class="flex flex-wrap -mx-3 mb-3 mt-2">
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                ...
                                id="grid-last-name" type="text" name="id_item" value="{{ $dataitem->id_item }}">
                            @error('id_item')
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" name="nama_item" value="{{ $dataitem->nama_item }}">
                            @error('nama_item')
                                <small class="text-red-600 font-bold">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                ...
                                id="grid-first-name" type="text" name="uom" value="{{ $dataitem->uom }}">
                            @error('uom')
                                <small class="text-red-600 font-bold">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                id="grid-first-name" type="text" name="harga_beli" value="{{ $dataitem->harga_beli }}">
                            @error('harga_beli')
                                <small class="text-red-600 font-bold">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                id="grid-first-name" type="text" name="harga_jual" value="{{ $dataitem->harga_jual }}">
                            @error('harga_jual')
                                <small class="text-red-600 font-bold">{{ $message }}</small>
                            @enderror
                        </div>
